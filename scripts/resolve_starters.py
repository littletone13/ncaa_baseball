...
def resolve_starters(
    ...
    for _, game in schedule.iterrows():
        ...
        rows.append({
            ...
            "hp_confirmed": int(bool(hp_override) or str(hp_id).startswith("d1b_") or str(hp_idx_raw).startswith("d1b_")),
            "ap_confirmed": int(bool(ap_override) or str(ap_id).startswith("d1b_") or str(ap_idx_raw).startswith("d1b_")),
